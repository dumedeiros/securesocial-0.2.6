...
//    /**
//     * Metodo de autenticacao na rede social, sem salvar o usuario carregado no banco de dados.
//     * Usado, por exemplo, para fazer login do usuario em uma rede social e obter os dados
//     * para adicionar ao logins
//     *
//     * @return usuario logado na rede social
//     */
//    public SocialUser authenticateNoSaving() {
//        // authenticate against the 3rd party service (facebook, twitter, etc)
//        Map<String, Object> authContext = new HashMap<String, Object>();
//
//        SocialUser user = doAuth(authContext);
...
//    }
    ...
    public String getFullUrl() {
        ...
        args.put(TYPE, type);
        String masdasd = play.mvc.Router.getFullUrl(SECURESOCIAL_SECURE_SOCIAL_AUTHENTICATE, args);
        return play.mvc.Router.getFullUrl(SECURESOCIAL_SECURE_SOCIAL_AUTHENTICATE, args); //securesocial.SecureSocial.authenticate    type=.facebook
    }
