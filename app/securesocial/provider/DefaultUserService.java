...
public class DefaultUserService implements UserServiceDelegate {
    ...
    public Map<String, SocialUser> users = Collections.synchronizedMap(new HashMap<String, SocialUser>());
    public Map<String, SocialUser> activations = Collections.synchronizedMap(new HashMap<String, SocialUser>());
    public Map<String, SocialUser> resetRequests = Collections.synchronizedMap(new HashMap<String, SocialUser>());
